...
L["Do you wish to accept the plan? Trusting this character will suppress this warning in the future."] = true
...
L["Everyone"] = true
L["Individual"] = true
L["The following assignments failed to update"] = true
L["Group"] = true
L["Ranged"] = true
L["Melee"] = true
...
L["Other"] = true
L["Clears all saved trusted characters. You will see a warning each time a new character sends a plan to you."] = true
