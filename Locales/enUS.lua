...
L["Clears all saved trusted characters. You will see a confirmation dialogue each time a non-trusted character sends a plan to you."] =
	true
L["Click the"] = true
L["Click the Boss button, navigate to Filter Spells, and click an ability to hide it from the timeline."] = true
L["Click the Plan button, and then click New Plan."] = true
L["Click the Simulate Reminders button again to stop previewing."] = true
L["Click the Simulate Reminders button to preview reminders for the current plan."] = true
L["Click the maximize button to continue the tutorial."] = true
L["Clicking the Boss button lets change the current plan boss, adjust phase timings, and show/hide boss abilities."] =
	true
...
L["Reminder"] = true
L["Reminders are currently disabled globally. Enable them in Preferences to modify this planÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s reminder setting."] =
	true
...
L["Reminders can be toggled on and off on a per-plan basis using this checkbox or globally in the"] = true
L["Reminders can be toggled on and off on a per-plan basis using this checkbox or globally in the Reminder section of the"] =
	true
L["Removed"] = true
...
L["The"] = true
L["The Assignment Timeline is updated to reflect the spell. The cooldown duration of the spell is shown as the alternating grey texture."] =
	true
L["The Menu Bar contains high level categories for managing plans, modifying bosses, editing rosters, and settings."] =
	true
...
L["This interactive tutorial walks you the key features of Encounter Planner. You can close this window at any time and pick up where you left by clicking the"] =
	true
L["This plan will be used throughout this tutorial. Select"] = true
L["Time"] = true
L["Time:"] = true
L["Timeline"] = true
...
L["also indicates whether reminders are enabled for a plan.\n\nUncheck the checkbox to disable reminders for this plan"] =
	true
L["and select a spell from the"] = true
...
L["to"] = true
L["to 30 seconds and press enter."] = true
L["to one of the spells you used in another assignment"] = true
