...
L["Position of Progress Bar duration text."] = true
L["Bar Texture"] = true
...
L["Death"] = true
L["Animation"] = true
L["Whether to show a bounce animation when a Message first appears."] = true
L["Bar Order"] = true
L["Message Order"] = true
L["Whether to sort Progress Bars by ascending or descending expiration time."] = true
L["Whether to sort Messages by ascending or descending expiration time."] = true
