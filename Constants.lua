...
Private.constants = {
	...
	textures = {
		...
		kTextCenterAlign = [[Interface\AddOns\EncounterPlanner\Media\icons8-align-text-center-32.tga]],
		kTextLeftAlign = [[Interface\AddOns\EncounterPlanner\Media\icons8-align-text-left-32.tga]],
		kTextRightAlign = [[Interface\AddOns\EncounterPlanner\Media\icons8-align-text-right-32.tga]],
