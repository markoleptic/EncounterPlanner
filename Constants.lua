...
-   Spell Database Updates
    -   Removed the following spells: Adaptive Swarm, Amplify Curse, Ancestral Protection Totem, Apocalypse, Bastion of Light, Bilescourge Bombers, Blast Wave, Blood Tap, Blooddrinker, Bonestorm, Bulk Extraction, Cenarion Ward, Cloudburst Totem, Cold Blood, Coordinated Assault, Dampen Harm, Dark Ascension, Demonic Strength, Displacement, Divine Word, Earthen Wall Totem, Emerald Communion, Engulf, Eye of Tyr, Fel Barrage, Fel Eruption, Final Reckoning, Fire Elemental, Firestorm, Flagellation, Flanking Strike, Fury of the Eagle, Ghostly Strike, Grimoire: Felguard, Icy Veins, Invigorate, Lightning Lasso, Lightwell, Liquid Magma Totem, Luminous Barrier, Mass Barrier, Moment of Glory, Nature's Vigil, Netherwalk, Oblivion, Overgrowth, Phantom Singularity, Power Word: Life, Premonition, Primordial Wave, Psychic Horror, Raise Abomination, Renewal, Rune Tap, Sacrificial Pact, Shadow Crash, Shattering Star, Shifting Power, Soul Rot, Spearhead, Spiritbloom, Stone Bulwark Totem, Stone Bulwark Totem, Storm Earth and Fire, Storm Elemental, Symbol of Hope, Symbols of Death, Thunderous Roar, Tombstone, Totemic Recall, Vile Taint, Void Shift, Warbreaker, Warrior of Elune, Weapons of Order, Wellspring, Barrier of Faith, Skullsplitter, Summon White Tiger Statue.
    -   Adjusted the available roles for the following spells: Jadefire Stomp, Quell, Rebuke, Skull Bash, Spear Hand Strike. 
    -   Added the following spells: Tentacle Slam.
    -   If you think any of the changes were made in error, please reach out and I can add them back.
-   Miscellaneous
    -   Added the Devourer Demon Hunter spec.
    -   The default status bar texture, "Clean", is now included with EP and is registered with LibSharedMedia on addon load.
    -   Fixed an issue where spec icons were not appearing beside text on the assignment timeline.
]]
