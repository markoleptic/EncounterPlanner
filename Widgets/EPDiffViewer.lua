...
do
	...
	local function OnAcquire(self)
		...
		self.scrollFrame:SetScrollChild(self.mainContainer.frame --[[@as Frame]], true, false)
	...
	local function Constructor()
		...
		windowBarText:SetText(L["Plan Change Request"])
		...
		text:SetPoint("TOP", windowBar, "BOTTOM", 0, -k.ContentFramePadding.y)
		text:SetPoint("LEFT", frame, "LEFT", k.ContentFramePadding.x, 0)
		text:SetPoint("RIGHT", frame, "RIGHT", -k.ContentFramePadding.x, 0)
