...
local frameBackdropColor = { 0, 0, 0, 0.5 }
local frameBackdropBorderColor = { 0.25, 0.25, 0.25, 0.5 }
local optionsFrameBackdropColor = { 0, 0, 0, 0.75 }
local optionsFrameBackdropBorderColor = { 0.25, 0.25, 0.25, 0.75 }
local defaultFrameHeight = 30
local defaultFrameWidth = 400
local optionsWidgetHeight = 24
...
local function OnAcquire(self)
	...
	textAlignLabel:SetHeight(optionsWidgetHeight)
	textAlignLabel:SetFrameWidthFromText()
	local fontSizeLabel = AceGUI:Create("EPLabel")
	fontSizeLabel:SetText("Font Size: ")
	fontSizeLabel:SetHeight(optionsWidgetHeight)
	...
	self.alignLeftButton:SetBackdropColor(unpack(backdropColor))
	self.alignLeftButton:SetHeight(optionsWidgetHeight)
	self.alignLeftButton:SetWidth(optionsWidgetHeight)
	...
	self.alignCenterButton:SetBackdropColor(unpack(backdropColor))
	self.alignCenterButton:SetHeight(optionsWidgetHeight)
	self.alignCenterButton:SetWidth(optionsWidgetHeight)
	...
	self.alignRightButton:SetBackdropColor(unpack(backdropColor))
	self.alignRightButton:SetHeight(optionsWidgetHeight)
	self.alignRightButton:SetWidth(optionsWidgetHeight)
	...
	self.increaseFontSizeButton:SetBackdropColor(unpack(backdropColor))
	self.increaseFontSizeButton:SetWidth(optionsWidgetHeight)
	self.increaseFontSizeButton:SetHeight(optionsWidgetHeight)
	...
	self.decreaseFontSizeButton:SetBackdropColor(unpack(backdropColor))
	self.decreaseFontSizeButton:SetWidth(optionsWidgetHeight)
	self.decreaseFontSizeButton:SetHeight(optionsWidgetHeight)
	...
	anchorDropdownLabel:SetHeight(optionsWidgetHeight)
	...
	self.anchorDropdown:SetHeight(optionsWidgetHeight)
	...
	relativeAnchorDropdownLabel:SetHeight(optionsWidgetHeight)
	...
	self.relativeAnchorDropdown:SetHeight(optionsWidgetHeight)
	...
	anchorFrameLabel:SetHeight(optionsWidgetHeight)
	...
	self.anchorFrameNameLabel:SetHeight(optionsWidgetHeight)
	...
	self.chooseAnchorFrameButton:SetHeight(optionsWidgetHeight)
	self.chooseAnchorFrameButton:SetWidthFromText()
	self.chooseAnchorFrameButton:SetFullWidth(true)
	self.chooseAnchorFrameButton:SetBackdropColor(unpack(backdropColor))
	...
	self.simulateButton:SetHeight(optionsWidgetHeight)
	self.simulateButton:SetWidth(100)
	self.simulateButton:SetFullWidth(true)
	self.simulateButton:SetBackdropColor(unpack(backdropColor))
...
local function Constructor()
	...
	frame:SetBackdropColor(unpack(frameBackdropColor))
	frame:SetBackdropBorderColor(unpack(frameBackdropBorderColor))
	...
	optionsFrame:SetBackdropColor(unpack(optionsFrameBackdropColor))
	optionsFrame:SetBackdropBorderColor(unpack(optionsFrameBackdropBorderColor))
	optionsFrame:Hide()
